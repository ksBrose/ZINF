...
//  Desenha jogador
    if (player->vidas > 0)
    {
        ...
        case 'W':
            ...
            {
                DrawTexture(sprites->attack_up, player->rec.x, player->rec.y -50, GREEN);
                player->attacktimer ++;
        ...
        case 'S':
            ...
            {
                DrawTexture(sprites->attack_down, player->rec.x, player->rec.y +50, GREEN);
                player->attacktimer ++;
                if(player->attacktimer > TIMEATTACK)
                {
                     player->attackDown = false;
        ...
        case 'A':
            ...
            {
                DrawTexture(sprites->attack_left, player->rec.x -50, player->rec.y , GREEN);
                player->attacktimer ++;
                if(player->attacktimer > TIMEATTACK)
                {
                     player->attackLeft = false;
        ...
        case 'D':
            ...
            {
                DrawTexture(sprites->attack_right, player->rec.x +50, player->rec.y , GREEN);
                player->attacktimer ++;
                if(player->attacktimer > TIMEATTACK)
                {
                     player->attackRight = false;
...
void checa_colisao_espada(Character *enemy, char mapaJogo[][COLUNAS], Infos *settings, Character *player)
{
    ...
    espadaV.y = player->rec.y -50 ;
    espadaV.width =   50;
    espadaV.height =  150;
    espadaH.x = player->rec.x -50;
