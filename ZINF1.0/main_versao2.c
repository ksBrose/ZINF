...
void display_jogo(Character *player, Character enemy[], char mapaJogo[][24], Textures *sprites, Infos *settings)
{
...
//  Desenha monstros
    ...
    for (int inimigo = 0; inimigo < MAX_INIMIGO; inimigo++)
        DrawTexture(sprites->enemy_front, enemy[inimigo].posXatual, enemy[inimigo].posYatual, WHITE);
...
//  Desenha jogador
    ...
    DrawTexture(sprites->player_front, player->posXatual, player->posYatual, WHITE);
